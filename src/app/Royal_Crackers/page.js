...
export default function Home() {
  return (
    <>
      <NavBars />
      <div className="flex w-full h-screen max-lg:justify-center lg:flex-row-reverse max-lg:px-[10%] pl-[30%] pr-[10%]">
        <div className="h-fit  pt-36 pb-12 flex flex-col gap-y-4">
          ...
          <p className="font-regular">
            ...
            once-popular snack food company which manufactures saltine crackers
            ...
            father's mansion with Stebe's wife Deb and their son Matt as they
            deal with competition from Dennison Snacks and experience different
